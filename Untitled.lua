...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "اهلا وسهلا بكم في كروب_💋/نور الكروب بشوفتك عبي اقرأ تحتߙʢݤ️ '"..string.gsub(msg.to.print_name, "_", " ").."'\n"
      local text = sambutan..about..rules.."\n"
      local text = text.."نورت الكروب ياوردة  اكتب >>مجموعة الدعم  << وادخل 😍❤️ />> "..nama
      local receiver = get_receiver(msg)
